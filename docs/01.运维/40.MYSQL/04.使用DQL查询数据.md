---
title: 使用DQL查询数据
date: 2023-04-20 16:10:24
permalink: /pages/2905fc/
categories:
  - 运维
  - MYSQL
tags:
...
测试：
SELECT a.ID,APP_CODE,INIT_REPLICAS,
FROM stateless_app WHERE cluster_code='ZD_BCORE_PROD_CSF_CLS'
LEFT JOIN t_app_container b 
ON a.ID=b.app_id
