...
const DOMAIN_NAME = 'zhangst94.github.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "运维技术笔记",
      description: '运维技术博客，积跬步以至千里，致敬每个爱学习的你',
    }
  },
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '运维',
        link: '/yunwei/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
      },
      {
        text: '工作',
        link: '/work/',
    ...
    logo: '/imgs/logo.png', // 导航栏logo
    repo: 'zhangst94/zhangst94.github.io', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'zhang', // 必需
      link: 'https://github.com/zhangst94', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'zhang | <a href="https://github.com/zhangst94/zhangst94.github.io/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
